...
%o`, message, error2, detail);
  ...
  var room_controller_default = class extends Controller {
    ...
    readServerHistory() {
      ...
      try {
        ...
        console.log("Failed to parse history data:", error2);
        return [];
      }
    }
    // Real-time connection management
    setupRealtimeConnection() {
      this.subscription = consumer_default.subscriptions.create(
    ...
    startPolling() {
      ...
      console.log(`\u{1F504} Starting polling every ${interval / 1e3} seconds for room:`, this.roomIdValue);
    ...
    eligibleCount() {
      ...
      if (this.excludeWinnersChecked()) {
        const winnerIds = new Set(
          (this.history || []).flatMap((entry) => entry.selected || []).map((s) => s.id).filter((id) => Boolean(id))
        );
    ...
    async shareInvite() {
      ...
      try {
        ...
        console.log("Share failed:", error2);
        const copyHandler = new CopyHandler(this);
        copyHandler.showFeedback("\u5171\u6709\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F", 2e3, "text-red-600");
      }
    }
    // QR code
    toggleQr(event) {
    ...
    async generateQr() {
      ...
      const url = this.inviteUrlTarget.textContent.trim();
      try {
        await import_qrcode.default.toCanvas(this.qrCanvasTarget, url, { width: 200, margin: 1 });
        this.qrGenerated = true;
      } catch (error2) {
        console.log("QR code generation failed:", error2);
  ...
  var MessageHandler = class {
    ...
    handlePing(data) {
      console.log("\u{1F3D3} ActionCable ping received:", data.message);
    }
    handleParticipantsUpdate(data) {
      console.log("\u{1F465} Updating participants list:", data.participants.length, "participants");
  ...
  var CopyHandler = class {
    ...
    showError(error2) {
      ...
      this.showFeedback("\u30B3\u30D4\u30FC\u5931\u6557", 2e3, "text-red-600");
    }
  ...
  // app/javascript/controllers/name_form_controller.js
  var STORAGE_KEY = "chooseYou.name";
  var name_form_controller_default = class extends Controller {
    ...
    check() {
      ...
      this.warningTarget.textContent = isTaken ? "\u540C\u3058\u540D\u524D\u306E\u53C2\u52A0\u8005\u304C\u3044\u307E\u3059\u3002\u533A\u5225\u3067\u304D\u308B\u540D\u524D\u306B\u3059\u308B\u3068\u5206\u304B\u308A\u3084\u3059\u304F\u306A\u308A\u307E\u3059" : "";
    ...
    remember() {
      ...
      try {
        ...
        console.log("Failed to save name to localStorage:", error2);
      }
    }
    readStoredName() {
      try {
        ...
        console.log("Failed to read name from localStorage:", error2);
        return null;
      }
    }
  };
