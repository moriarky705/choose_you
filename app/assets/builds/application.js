...
%o`, message, error2, detail);
  ...
  var room_controller_default = class extends Controller {
    ...
    renderParticipants(list) {
      ...
      this.participantsTarget.innerHTML = list.map(
    ...
    renderSelection(selected, count) {
      ...
      this.selectionListTarget.innerHTML = selected.map(
    ...
    async copyInvite() {
      ...
      const show = (msg, ms = 1500, cls = "text-green-600") => {
        ...
        this._copyTimer = setTimeout(() => {
          this.copyFeedbackTarget.style.display = "none";
        }, ms);
      };
      const showOk = () => show("\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F", 1500, "text-green-600");
      const showErr = (err) => {
        console.error("Copy failed", err);
        show("\u30B3\u30D4\u30FC\u5931\u6557", 2e3, "text-red-600");
      };
